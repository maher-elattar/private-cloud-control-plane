 ...
 * Route table.
 *
 * Mirrors the reference console's URL shape: project-level tabs live under `/servers`, and each
 * server owns a nested set of management tabs under `/servers/:id`.
 */
    ...
    <ConsoleProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="console/:id" element={<VncConsole />} />
